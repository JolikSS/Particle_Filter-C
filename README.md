...
Файлы `output.csv` и `particles.csv` создаются после запуска программы. Изображение в папке `docs/images/` используется для отображения графика в README на GitHub.
